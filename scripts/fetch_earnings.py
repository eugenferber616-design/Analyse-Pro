...
# ---- robuste Defaults aus config.yaml ----
...
# Fallback: ~60_000 / PER_MIN, mind. 1.2s
...
def fetch(a, b, lim, token, retries=3):
    """Finnhub-Earnings-Kalender für [a,b] mit RateLimit & 429-Retry abholen."""
    params = {
...
def main():
    ...
    # Wichtig: positional args, kein Keyword-Arg
    ...
    # pro Symbol das früheste kommende Datum nehmen
    by = {}
    for r in all_rows:
